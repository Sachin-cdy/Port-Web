    ...
    <>
      <div name="Home"
        ...
        <div className="flex flex-col md:flex-row">
            ...
            <div className="flex flex-col items-center md:flex-row justify-between space-y-6 md:space-y-0 ">
              <div className=" space-y-2">
                ...
                <ul className="flex space-x-5">
                  ...
                  <li>
                    <a href="https://www.instagram.com/sachin_kcee_12" target="blank">
          ...
          <div className="md:w-1/2 md:ml-48 md:mt-20 mt-8 order-1 grid place-items-center h-full">
            <img
              src={pic}
              alt="Profile"
              className="w-[450px] aspect-square rounded-full object-cover"
            />
          </div>
        </div>
      </div>
